...
namespace MITHRAS::SERIALIZATION
{
	namespace
	{
		constexpr std::uint32_t kSerializationID = 'THIM';

		void OnSave(SKSE::SerializationInterface* a_intfc)
		{
			MITHRAS::MASTERY::Manager::GetSingleton()->Serialize(a_intfc);
		}

		void OnLoad(SKSE::SerializationInterface* a_intfc)
		{
			MITHRAS::MASTERY::Manager::GetSingleton()->Deserialize(a_intfc);
		}

		void OnRevert(SKSE::SerializationInterface*)
		{
			MITHRAS::MASTERY::Manager::GetSingleton()->OnRevert();
		}
	}
